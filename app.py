# -*- coding: utf-8 -*-
"""
Created on Tue Sep 28 22:55:45 2021
...
def predict():
    if request.method == 'POST':
        ...
        if prediction==1:
             return render_template('index.html',prediction_text="The Customer needs better attention & service")
        else:
             return render_template('index.html',prediction_text="The Customer will stay with the bank")
